...
`*sfcnodes.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `sfcnodes.File(reader io.Reader, filename string, contentType string)`
